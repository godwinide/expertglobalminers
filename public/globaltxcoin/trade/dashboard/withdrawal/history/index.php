...
<head>
    ...
    <title><?php echo sitename ?>| Withdrawal History</title>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            ...
                            <h5><?php echo $row_access['currency'];?> <?php echo number_format($row_access['bal'],2,'.',',');?></h5> <i class="fa fa-angle-down"></i></h4>
                    ...
                    <div class="col-lg-8 mt-5">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <?php 
								$email = $row_access['email']; 
							$sql = mysql_query("SELECT * FROM withdrawal WHERE email='$email'") or die(mysql_error());
