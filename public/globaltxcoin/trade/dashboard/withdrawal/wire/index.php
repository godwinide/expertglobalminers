...
<body>
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
				...
				<a href="../../assets/images/bg/logo.png" alt="logo"></a>	
                </div>
            </div>
            <div class="main-menu">
  ...
  <ul class="menu">
    ...
    <li><a href="../../../dashboard" >Trade</a></li>
    <li><a href="../../history" >Trade History</a></li>
                    ...
                    <div class="col-lg-8 mt-5">
                        <div class="card">
                            <div class="card-body">
								...
								if($xamount <= $row_access['bal'] !== true){ 
								...
								$upd = mysql_query("INSERT INTO withdrawal(orderid,user,email,amount,currency,status,method,accno,date,action,accname, bankname,swiftcode,rno,bankaddress) VALUES('$id','$user','$email','$xamount','$cur','$stat','$method','$accno','$date','$action','$accname','$bankname','$swift','$rno','$bankaddress')") or die(mysql_error());
								
 $pu = mysql_query("UPDATE users SET paymethod='WireTransfer' WHERE email='$email'");								
								
								echo '<div class="alert alert-success"><strong>Request Successful</strong>. Our Account department will contact you shortly regarding your payment. Thank you!</div>';	
								
								}
										}else{echo '<div class="alert alert-danger"><strong>Minimum withdrawal '.$cur.''.$min.'</div>';}
                        ...
                        <p><img src="../../assets/images/wire.png" width="150" height="10"></p>
                                 ...
                                 <div class="form-group">
                                            ...
                                            <input class="form-control" name="amount" type="text"  id="amount" required onKeyUp="javascript:this.value=Comma(this.value);" >
       ...
       return x1 + x2;       
                 ...
                 <div class="form-group">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <input class="form-control" name="bankname" type="text" value="" id="example-text-input"  required>
                                        </div>
                                         ...
                                         <div class="form-group">
                                           ...
                                           <div class="form-group">
                                            ...
                                            <input class="form-control" name="rno" type="text" value="" id="example-text-input"  required>
                                        </div>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input class="form-control" name="bankaddress" type="text" value=" " id="example-text-input"  required>
                                        </div>
