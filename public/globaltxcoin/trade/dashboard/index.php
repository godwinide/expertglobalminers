                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li><a href="market/stock">Stock</a></li>
                                    <li><a href="market/crypto">Cryptocurrency</a></li>
                                    <li><a href="market/indices">Indices</a></li>
                                    <li><a href="market/cfd">Oil & Gas</a></li>
...
embedder.parentNode.appendChild(s);
  ...
  <ul class="menu">
    ...
    <li><a href="../dashboard" class="selected" >Forex</a></li>
    <li><a href="market/stock" >Stock</a></li>
    <li><a href="market/crypto" >Cryptocurrency</a></li>
    <li><a href="market/cfd">Oil & Gas</a></li>
   ...
   <li>
   <button class="btn btn-danger" data-toggle="modal" data-target="#exampleModalLong">Sell Bitcoin</button></li>
   
   <li>
   <button class="btn btn-success" data-toggle="modal" data-target=".bd-example-modal-lg">Buy Bitcoin</button>
...
<label class="switch">
 <input  <?php 
  ...
  if($tpos !== $aut) {echo "checked=\"checked\""; echo "disabled=\"disabled\""; } 
  
   ?>  id="toggle-trigger" type="checkbox" data-toggle="toggle">
...
<button class="btn btn-primary"  onclick="toggleOnByInput(); relo() ">ExpaTrader</button>
<button class="btn btn-secondary" onclick="toggleOffByInput(); meta()">MetaTrader</button>
<script>
  function toggleOn() {
  ...
  function toggleOnByInput() {
	...
	<?php
	  ...
	  mysql_query("UPDATE users SET auto='on' WHERE email='$email'");
  ...
  function toggleOffByInput() {
    $('#toggle-trigger').prop('checked', false).change()
	  ...
	  function relo(){
		  ...
		  function meta(){
		  window.location.href="metatrader";
		  }
</script>

</li>

<li><button class="btn btn-success" data-toggle="modal" data-target="#exampleModalCenter">Deposit Fund</button></li>
  ...
  "container_id": "tradingview_f263f"
			...
			<iframe src="https://trade.mql5.com/trade?demo_all_servers=1&amp;startup_mode=open_demo&amp;lang=en&amp;save_password=off" allowfullscreen="none" style="width: 100%; height: 695px; border: none;"></iframe>
...
s1.async=true;
s1.src='https://embed.tawk.to/60383c641c1c2a130d628dbe/1evdqnqvi';
s1.charset='UTF-8';
