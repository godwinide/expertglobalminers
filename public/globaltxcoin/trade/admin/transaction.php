          ...
          <div class="col-lg-9 col-md-12">
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <h2><i class="fa fa-map-marker red"></i><strong>TRADE HISTORY</strong></h2>
			  ...
			  $sql = mysql_query("SELECT * FROM trade ORDER BY time DESC") or die(mysql_error());
               ...
               <table class="table no-margin">
                  ...
                  <tr>
					...
					?>
                     ...
                     <td><a href="trade.php?ref=<?php echo $data['id']; ?>"><button class="btn btn-<?php echo $colo; ?>"><?php echo $data['action'];?></button></a> </td>
