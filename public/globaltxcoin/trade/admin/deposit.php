        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-laptop"></i>deposit</li>
            </ol>
          </div>
        </div>
          ...
          <div class="col-lg-9 col-md-12">
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <h2><i class="fa fa-map-marker red"></i><strong>DEPOSIT REQUEST</strong></h2>
			  ...
			  $sql = mysql_query("SELECT * FROM deposit ORDER BY date DESC") or die(mysql_error());
               ...
               <table class="table no-margin">
                  ...
                  <tr>
                    ...
                    <td> <?php echo $data['date'];?></td>
                      ...
                      <td><a href="credit.php?id=<?php echo $data['orderno'];?>"><?php echo $data['action'];?> </a></td>
