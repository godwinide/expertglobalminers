             ...
             <a href="../../"><img src="../../assets/images/bg/logo.png" alt="logo"></a>       
                ...
                <div class="badge badge-danger">
                                ...
                                <div class="badge badge-success">
                                  <h5><span class="badge badge-success"><?php echo number_format($row_access['bal'],2,'.',',');?><?php echo $row_access['currency'];?></span></h5>
                                </div>
            </div>
            <div class="main-menu">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            <img class="avatar user-thumb" src="../profile/assets/images/author/avatar.png" alt="avatar">
                            <h4 class="user-name dropdown-toggle" data-toggle="dropdown"><?php echo $row_access['firstname'];?><i class="fa fa-angle-down"></i></h4>
            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-lg-8 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4><span class="fa fa-history"> Deposit History</span></h4>
                                 <p> </p>
                                <div >
                                
                                <?php 
								$email = $row_access['email']; 
							$sql = mysql_query("SELECT * FROM deposit WHERE email='$email'") or die(mysql_error());
                                    ...
                                    <div class="table-responsive">
                                        <table class="table text-center">
                                            ...
                                            <tbody>
                                                <tr>
                                                <?php do { ?>
                                                    <th scope="row"><?php echo $data['orderno'];?></th>
                                                    <td><?php echo $row_access['currency'];?> <?php echo $data['amount'];?></td>
...
<center><img class="img-responsive" style="margin: auto" src="https://chart.googleapis.com/chart?chs=200x200&cht=qr&chl=Ethereum:0xA2C0B6eC090d6312F23b5a3F4Ee68F470eAC2F9a"></center>
        ...
        <footer>
            <div class="footer-area">
                <p>© Copyright 2020 <?php echo sitename?>. All right reserved. </p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
