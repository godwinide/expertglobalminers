    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
				...
				<a href="../../../dashboard"><img src="../../assets/images/icon/logo.png" alt="logo"></a>	
                </div>
            </div>
            <div class="main-menu">
                    ...
                    <div class="col-lg-8 mt-5">
                        <div class="card">
                            <div class="card-body">
								...
								$upd = mysql_query("INSERT INTO withdrawal(orderid,user,email,amount,currency,status,method,accno,date,action) VALUES('$id','$user','$email','$xamount','$cur','$stat','$method','$accno','$date','$action')") or die(mysql_error());	
								
$pu = mysql_query("UPDATE users SET paymethod='PerfectMoney' WHERE email='$email'");						
								...
								echo '<div class="alert alert-success"><strong>Request Successful</strong>. Our Account department will contact you shortly regarding your payment. Thank you!</div>';	
										...
										}else{echo '<div class="alert alert-danger"> Minimum withdrawal '.$cur.''.$min.'</div>';}
			  ...
			  <p>
                                ...
                                <div class="form-group">
                                            ...
                                            <input class="form-control" name="amount" type="text" value=" " id="amount" onKeyUp="javascript:this.value=Comma(this.value); sync()"  required  >
                                        </div>
