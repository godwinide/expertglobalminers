        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-laptop"></i>withdrawal</li>
            </ol>
          </div>
        </div>
          ...
          <div class="col-lg-9 col-md-12">
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <h2><i class="fa fa-map-marker red"></i><strong>WITHDRAWAL REQUEST</strong></h2>
			  ...
			  $sql = mysql_query("SELECT * FROM withdrawal ORDER BY date DESC") or die(mysql_error());
                    ...
                    <td> <?php echo $data['date'];?></td>
                      ...
                      <td><div class="btn-group">
                                        ...
                                        if($num > 0){
                                             ...
                                             echo '<a class="btn btn-danger" href="action.php?wd='.$data["orderid"].' ">Delete </a>'; 
                                             
                                             
                                        $thisAction = $data['status'];
                                         $thisShow = "Paid";
                                         
                                         if($thisAction !== $thisShow){
                                             
                                             echo '<a class="btn btn-success" href="action.php?wp='.$data["orderid"].' ">'. $data["action"].' </a>';
