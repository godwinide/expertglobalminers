                    ...
                    <div class="col-lg-4 mt-5">
                        <div class="card">
                            ...
                            <div class="card-body">
								...
								$upd = mysql_query("UPDATE users SET paymethod='$method' WHERE email='$email'") ;	
								
								if($upd){
								
								echo '<li class="fa fa-bank"> Bank Transfer</li> <div class="alert alert-success"><strong>Set as default withdrawal method</strong></div>
								...
								echo '<img src="../assets/images/bitcoin.jpg"> <div class="alert alert-success"><strong>Set as default withdrawal method</strong></div>
								...
								echo '<img src="../assets/images/pmhov.jpg"> <div class="alert alert-success"><strong>Set as default withdrawal method</strong></div>
                    ...
                    <div class="col-lg-8 mt-5">
                        <div class="card">
                            <div class="card-body">
								...
								$upd = mysql_query("UPDATE users SET dob='$dob',phone='$phone' WHERE email='$email'") ;	
								if($upd){
                                ...
                                <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" value="<?php echo $row_access['firstname'];?> <?php echo $row_access['lastname'];?>" id="example-text-input" readonly>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="example-datetime-local-input" class="col-form-label">Date of Birth</label>
                                            <input name="dob" class="form-control" type="date" value="<?php echo $row_access['dob'];?>" id="example-datetime-local-input" required>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="example-tel-input" class="col-form-label">Telephone</label>
                                            <input  name="phone" class="form-control" type="tel" value="<?php echo $row_access['phone'];?>" id="example-tel-input" required>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="example-search-input" class="col-form-label">Email Address</label>
                                            <input class="form-control"  readonly type="email" value="<?php echo $row_access['email'];?>" id="example-search-input">
                                        </div>
...
s1.async=true;
s1.src='https://embed.tawk.to/60053459a9a34e36b96d7c00/1esa590ne';
s1.charset='UTF-8';
