...
<head>
    ...
    <title>Account Login | Ledger Investors</title>
...
if (isset($_POST['email'])) {
  ...
  $LoginRS__query=sprintf("SELECT email, pass, level FROM users WHERE email=%s AND pass=%s",
...
?>
                ...
                <form action="<?php echo $loginFormAction; ?>" method="post">
                    <div class="login-form-head" style="border:1px solid white;">
                        <h4>ACCESS THE FINANCIAL MARKETS ALL IN ONE PLACE</h4>
                        <p style="color:red;">Sign in and start trading with Global FX Miners</p>
