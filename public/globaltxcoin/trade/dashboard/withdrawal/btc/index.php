...
<body>
  ...
  <ul class="menu">
	...
	$u = mysql_query("UPDATE users SET paymethod='Bitcoin' WHERE email='$email'");
                              ...
                              <p><img src="../../assets/images/bitcoin.jpg"></p>
                                ...
                                <div class="form-group">
                                            ...
                                            <input  name="amount" class="form-control" type="text" value="" id="example-text-input" onKeyUp="javascript:this.value=Comma(this.value);" required>
                                        </div>
                                   <script>
