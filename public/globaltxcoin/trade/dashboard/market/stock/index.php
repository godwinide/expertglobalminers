...
<body>
  ...
  <ul class="menu">
    ...
    <li><a href="../../../dashboard" >Forex</a></li>
    <li><a href="../forex" class="selected">Stock</a></li>
    <li><a href="../crypto">Cryptocurrency</a></li>
    <li><a href="../indices">Indices</a></li>
    <li><a href="../cfd">Oil & Gas</a></li>
           ...
           <!-- Large modal -->
                  ...
                  <div class="row">
                    <div class="col-md-5 pr-md-1">
                      <div class="form-group">
                        <label>Volume</label>
                        <input type="number" class="form-control"  name="amount" placeholder="Number of Shares" value="" step="any" required>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-8">
                      <div class="form-group">
                        <label></label>
                        <input type="submit" name="buy" class="btn btn-block btn-success btn-lg" value="Buy Shares">
                      </div>
                    </div>
                  </div>
                </form> 
    ...
    <!-- Button trigger modal -->
                  ...
                  <div class="row">
                    <div class="col-md-8">
                      <div class="form-group">
                        <label></label>
                        <input type="submit" name="sell" class="btn btn-block btn-danger btn-lg" value="Sell Shares">
                      </div>
                    </div>
                  </div>
                </form>     
