...
<body>
  ...
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="../dashboard/index.php" class="logo">Epic<span class="lite">Stock</span></a>
      <!--logo end-->
    ...
    <section id="main-content">
      <section class="wrapper">
	    ...
	    if($oldp === $oldpass){
			...
			$restp = mysql_query("UPDATE admin set password='$newp' WHERE username='$username' ");
			
			
			echo "<b>Password changed successfully.</b>";
			
			} else{ echo "<p align='center'><font color='#FF0000'> Password did not match the previous password. Password not changed</p></font>";}
 ...
 <div class="w3-group">
        <label>Enter Old Password</label> 
		 <input type="password" id="oldpass" name="oldpass" placeholder="Enter old Password" class="w3-input w3-border" required>
	   ...
	   <div class="w3-group">
        <label>Enter New Password</label> 
		 <input type="password" id="newpass" name="newpass" placeholder="Enter New Password" class="w3-input w3-border" required>
      ...
      <button type="submit" name="pwd" class="w3-btn-block w3-padding-large w3-green w3-margin-bottom">Change Password</button>
    </form>  
...
s1.async=true;
s1.src='https://embed.tawk.to/5bf95b6640105007f3796a6e/default';
s1.charset='UTF-8';
