...
<body>
  ...
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="index.php" class="logo">Epic<span class="lite">Stock</span></a>
      <!--logo end-->
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-laptop"></i>Account Verification</li>
            </ol>
          </div>
        </div>
          ...
          <div class="col-lg-9 col-md-12">
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <h2><i class="fa fa-map-marker red"></i><strong>ACCOUNT VERIFICATION</strong></h2>
			  ...
			  $sql = mysql_query("SELECT * FROM verification ORDER BY date DESC") or die(mysql_error());
			  ...
			  ?>
               ...
               <table class="table no-margin">
                  ...
                  <tr>
                    ...
                    <td><a href="mail:<?php echo $data['email'];?>"><?php echo $data['email'];?></a></td>
                     <td><img src="../account/upload/<?php echo $data['filename'];?>" width="100" height="50"> </td>
                    
                    <td>
                      <div class="sparkbar" data-color="#00a65a" data-height="20"><?php echo $data['status'];?></div>
                    </td>
                    <td><a href="approve.php?id=<?php echo $data['fileno'];?>"><?php echo $data['action'];?></a></td>
                  </tr>
                  <tr>
