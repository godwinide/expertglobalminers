  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-laptop"></i> Credit</h3>
	  ...
	  $pid = $_GET['id'];
		...
		$check = mysql_query("SELECT * FROM deposit WHERE orderno='$id' ") or die(mysql_error());
		
		$depo = mysql_fetch_array($check);
	   ...
	   $ema = $depo['email'];	  
	    ...
	    if($email === $mid){
			...
			$restp = mysql_query("UPDATE users SET bal=bal+$amount WHERE email='$email' ");
			
			$restp = mysql_query("UPDATE deposit SET status='$stat',action='$action' WHERE orderno='$orderno' ");
			
			echo '<div class="alert alert-success"><strong>Fund Added Successfully</strong> </div>';
...
<html>
<head>
<title>USD $amount Notification</title>
</head>
<body>
<p><h3>Hello $fname,</h3> </p>

We are glad to inform you that your Account <br>
has been credited with USD $amount. 
<p>
...
mail($to,$subject,$message,$headers);
 ...
 <div class="w3-group">
        <label>Member Email</label> 
		 <input type="email" id="mid" name="mid"  value="" class="w3-input w3-border" required>
    ...
    <div class="w3-group">
        <label>Order ID(optional)</label>
		 <input type="text" id="orderno" name="orderno"  value="<?php echo $pid; ?>" class="w3-input w3-border" >
		
      </div> 
	  
	  
      <button type="submit" name="credit" class="w3-btn-block w3-padding-large w3-green w3-margin-bottom">Add </button>
    </form>  
